...
public class V8 extends V8Object {
	...
	private InspectorCallbacks inspectorClient;
     ...
     * @return A new isolated V8 Runtime.
     */
    public static V8 createV8Runtime(final String globalAlias, final String tempDirectory, final String snapshotSources) {
        ...
        V8 runtime = new V8(globalAlias, snapshotSources);
        synchronized (lock) {
            runtimeCounter++;
        }
        return runtime;
    ...
    protected V8(final String globalAlias, String snapshotSources) {
        super(null);
        released = false;
        if (snapshotSources == null) {
        	v8RuntimePtr = _createIsolate(globalAlias);
        } else {
        	v8RuntimePtr = _createIsolateWithSnapshotBlob(globalAlias, snapshotSources);
        }
	...
	public void resetContext() {
		checkThread();
		resetContext(v8RuntimePtr);
	}

	public void sendInspectorMessage(String message) {
		sendInspectorMessage(v8RuntimePtr, message);
	}
	
	public void schedulePauseOnNextStatement() {
		schedulePauseOnNextStatement(v8RuntimePtr, "Break", "Break");
	}
    ...
    public void inspectorMessage(String theMessage) {
    	if (this.inspectorClient != null) {
    		this.inspectorClient.handleMessage(theMessage);
    	}
    }
    
    public void runMessageLoopOnPause() {
    	if (this.inspectorClient != null) {
    		this.inspectorClient.runMessageLoopOnPause();
    	}
    }

    public void quitMessageLoopOnPause() {
    	if (this.inspectorClient != null) {
    		this.inspectorClient.quitMessageLoopOnPause();
    	}
    }
    
    public void runIfWaitingForDebugger() {
    	if (this.inspectorClient != null) {
    		this.inspectorClient.runIfWaitingForDebugger();
    	}
    }
    ...
    protected void resetContext(final long v8RuntimePtr) {
    	_resetContext(v8RuntimePtr);
    }
    
    protected void sendInspectorMessage(final long v8RuntimePtr, final String message) {
    	 _sendInspectorMessage(v8RuntimePtr, message);
    }
    
    protected void schedulePauseOnNextStatement(final long v8RuntimePtr, String reason, String reasonDetail) {
    	_schedulePauseOnNextStatement(v8RuntimePtr, reason, reasonDetail);
    }
    ...
    private native long _createIsolateWithSnapshotBlob(String globalAlias, String snapshotSources);
    
    private native void _resetContext(long v8RuntimePtr);

    private native void _sendInspectorMessage(long v8RuntimePtr, final String message);
    
    private native void _schedulePauseOnNextStatement(long v8RuntimePtr, final String breakReason, final String reasonDetail);
    ...
    public void setInspectorClient(InspectorCallbacks client) {
